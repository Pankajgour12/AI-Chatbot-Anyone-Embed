          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-14 lg:gap-24 items-center">
            ...
            >
              ...
              <div className="flex flex-wrap gap-4 mt-10">
                ...
                <button className="px-7 py-3 rounded-xl border border-gray-600 text-white font-semibold hover:bg-gray-800 hover:scale-105 transition-all duration-300 backdrop-blur-md">
                  Learn More
                </button>
              </div>
            </motion.div>
