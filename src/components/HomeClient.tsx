  ...
  const features = [
    {
      ...
      description:
        "Integrate our AI chatbot seamlessly into your website with just a few lines of code. No technical expertise required, making it accessible for businesses of all sizes.",
    },
    {
      title: "Admin Controlled",
      description:
        "full control of your chatbot's knowledge base. Easily add, edit, or remove information to ensure your customers receive accurate and up-to-date answers.",
    },
    {
